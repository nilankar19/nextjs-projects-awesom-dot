...
function Footer() {
  return (
   ...
   <section className='container mx-auto'>
        ...
        <Image src={Logo}  alt="logo"  className="w-60 hero container max-w-screen-lg mx-auto text-center pb-5 mt-10  "/>
   ...
   <footer>
      ...
      text-sm pb-8"
      >
         <span className=" text-sm text-[#98A2B3] sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline"> Awesome dot</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-end  sm:mt-0">
            <a href="#" className="text-[#98A2B3] hover:text-gray-900 dark:hover:text-white">
